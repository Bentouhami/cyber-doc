---
name: asdhoconnect-contract-validator
description: Validate data contracts across Zod DTOs, backend DTOs, Doctrine entities, and TypeScript types. Use when fields, nullability, or enums change.
metadata:
  short-description: Check contract alignment and report mismatches
---
...
- Backend DTOs vs Doctrine entities.
...
3. Produce a mismatch report with fixes.
