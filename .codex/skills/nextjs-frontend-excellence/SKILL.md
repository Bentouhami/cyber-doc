...
description: Create or refactor CyberDoc Next.js 16 App Router pages/components with shadcn/ui, Tailwind CSS v4, Zod validation, strict TypeScript, and distinctive professional UI/UX.
---

# Next.js Frontend Excellence (CyberDoc)

## Scope

- Build or refactor pages, layouts, and components in `app` and `components`.
- Apply CyberDoc UI patterns, strict TypeScript, Zod validation, and shadcn/ui composition.
...
- Use existing route and navigation helpers from `lib/*` when linking.
- Keep file size under 300 lines and split responsibilities by component/hook.

## References

- Tokens and components map: `references/cyberdoc-frontend-tokens-components.md`
...
- [ ] Consistent UI with CyberDoc components and tokens.
