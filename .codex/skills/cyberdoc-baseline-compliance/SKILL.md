---
name: cyberdoc-baseline-compliance
description: Final compliance gate for CyberDoc before declaring work complete.
metadata:
  short-description: Final CyberDoc compliance checklist and report
---
...
Validate compliance with CyberDoc standards before declaring a task complete.
...
3. Security checks (route-level authz, least privilege, no sensitive output).
4. Data contract checks (Zod/DTO alignment, types/enums/nullability).
5. Documentation checks (updated under `/docs`, diagrams updated if needed).
